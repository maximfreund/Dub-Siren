/**
 * @file DefaultPresets.h
 * @author Seb Madgwick
 * @brief Default presets.
 */

#ifndef DEFAULTS_PRESETS_H
#define DEFAULTS_PRESETS_H
...
extern const SynthesiserParameters fogHorn;
extern const SynthesiserParameters levelUp;
extern const SynthesiserParameters marioCoin;
